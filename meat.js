  "https://www.youtube.com/watch?v=arznMgZisdU",
  "https://www.youtube.com/watch?v=jmsp0TQ-PDI",
  "https://www.youtube.com/watch?v=bPEP1eACDz8",
  "https://www.youtube.com/watch?v=HLr7V8DYWns",
  "https://www.youtube.com/watch?v=wtNI37KCw4o",
  "https://www.youtube.com/watch?v=xSHw0bJUD1o",
  "https://www.youtube.com/watch?v=vMmepSez_M0",
  "https://www.youtube.com/watch?v=2VLDecJXap8",
  "https://www.youtube.com/watch?v=jOz6kDG1pWo",
            ...
            const bots = BOT_AGENTS.map(agent => {
                const bot = {
                    ...
                    public: {
                        ...
                        roblox: false,
                        blessed: false,
                        x: getRandomInt(50, 950),
                        y: getRandomInt(50, 700),
                    }
                };
                room.users.push(bot);
                room.emit("update", { guid: bot.guid, userPublic: bot.public });
                return bot;
            });
            // Each bot says "Suggest a topic" once with a staggered delay
            bots.forEach((bot, i) => {
                setTimeout(() => {
                    room.emit("talk", { guid: bot.guid, text: "Suggest a topic" });
                    // Remove bot after it has spoken
                    setTimeout(() => {
                        room.emit("leave", { guid: bot.guid });
                        const idx = room.users.indexOf(bot);
                        if (idx !== -1) room.users.splice(idx, 1);
                    }, 3000);
                }, i * 800);
            });
        },
        "aitopic": async function() {
            const topic = Utils.argsString(arguments).trim();
            if (!topic) return;
            const room = this.room;
            const BOT_AGENTS = [
                { name: "Peedy",  color: "peedy"  },
            ...
            try {
                // Call OpenAI server-side — key never reaches the client
                ...
                const payload = JSON.stringify({
                    ...
                    messages: [
                        {
                            role: "system",
                            content: `You are writing a short fun script for 6 cartoon desktop assistant characters (Peedy, Bonzi, Max, Merlin, Robby, Genie) discussing a topic together. Write exactly 6 lines, one per character, in the format "Name: line". Keep each line under 80 characters, casual and fun.`
                        },
                        {
                            role: "user",
                            content: `Topic: ${topic}`
                ...
                const response = await new Promise((resolve, reject) => {
                    const req = https.request({
                        ...
                        headers: {
                            ...
                            "Authorization": "Bearer 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",
                ...
                // Parse lines like "Name: text"
                const lines = scriptText.split("\n").map(l => l.trim()).filter(l => l.length > 0);
                const botMap = {};
                bots.forEach(b => { botMap[b.public.name.toLowerCase()] = b; });
                let delay = 0;
                lines.forEach(line => {
                    ...
                    if (!bot) return;
                    setTimeout(() => {
                        room.emit("talk", { guid: bot.guid, text: text });
                    }, delay);
                    delay += 2500;
                });
                // Remove all bots after the script is done
                setTimeout(() => {
                    bots.forEach(bot => {
                        room.emit("leave", { guid: bot.guid });
                        const idx = room.users.indexOf(bot);
                ...
                // On error just clean up bots silently
                bots.forEach(bot => {
                    room.emit("leave", { guid: bot.guid });
                    const idx = room.users.indexOf(bot);
                    if (idx !== -1) room.users.splice(idx, 1);
